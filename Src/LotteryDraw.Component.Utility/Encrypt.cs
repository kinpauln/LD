...
namespace LotteryDraw.Component.Utility
{
    ...
    public class Encrypt
    {
        ...
        public static string Encode(string encryptString, string encryptKey = "www.choujiangma.com.7123456")
        {
        ...
        public static string Decode(string decryptString, string decryptKey = "www.choujiangma.com.7123456")
        {
            try
            {
