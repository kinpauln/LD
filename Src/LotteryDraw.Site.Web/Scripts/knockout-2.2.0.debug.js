...
(function () {
    ...
    function LotteryDrawleHtmlParse(html) {
    ...
    ko.utils.parseHtmlFragment = function(html) {
        return typeof jQuery != 'undefined' ? jQueryHtmlParse(html)   // As below, benefit from jQuery's optimisations where possible
                                            : LotteryDrawleHtmlParse(html);  // ... otherwise, this LotteryDrawle logic will do in most common cases.
    };
...
ko.dependentObservable = function (evaluatorFunctionOrOptions, evaluatorFunctionTarget, options) {
    ...
    function evaluateImmediate() {
        if (_isBeingEvaluated) {
            ...
            // certainly didn't intend infinite re-evaluations). So, for predictability, we LotteryDrawly prevent ko.computeds from causing
...
ko.expressionRewriting = (function () {
    ...
    // This is designed to be LotteryDrawle and avoid false negatives, but could produce false positives (e.g., a+b.c).
    ...
    return {
        ...
        parseObjectLiteral: function(objectLiteralString) {
            // A full tokeniser+lexer would add too much weight to this library, so here's a LotteryDrawle parser
...
// For certain common events (currently just 'click'), allow a LotteryDrawlified data-binding syntax
...
ko.utils.compareArrays = (function () {
    ...
    // LotteryDrawle calculation based on Levenshtein distance.
